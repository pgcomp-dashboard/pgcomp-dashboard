...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::group(['name' => 'portal', 'prefix' => 'portal'], function () {
        ...
        Route::put('user/update', [UserController::class, 'changePassword']);
        ...
        Route::get('user/productions', [ProductionController::class, 'userProductions']);
        Route::post('user/productions', [ProductionController::class, 'userCreateProduction']);
        Route::delete('user/productions/all', [ProductionController::class, 'deleteAll']);
        Route::apiResource('user/productions', ProductionController::class)->only(['update', 'destroy']);
        Route::post('user/productions/doi', [ProductionController::class, 'productionFromDoi']);
